...
<table>
    ...
    <tr>
        ...
        <td>IE8的专用标记，用来指定IE8浏览器去模拟某个特定版本的IE浏览器的渲染方式，以此来解决部分兼容问题。 </td>
        <td>
    ...
    <tr>
        <td>expires</td>
        <td>设定网页的过期时间。</td>
        <td><meta http-equiv="expires" content="Fri,12Jan200118:18:18GMT">
            <br>PS：必须使用GMT的时间格式
        </td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            <br><meta name="renderer" content="ie-stand">//默认IE标准模式
            <br>PS：360浏览器支持
        </td>
    </tr>
    <tr>

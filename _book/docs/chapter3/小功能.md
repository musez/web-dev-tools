...
**演示地址：**[https://musez.github.io/web-dev-tools/pages/textScroll/text_scroll1.html](https://musez.github.io/web-dev-tools/pages/textScroll/text_scroll1.html)
```html
<!DOCTYPE html>
<html lang="en">
<head>
...
**演示地址：**[https://musez.github.io/web-dev-tools/pages/textScroll/text_scroll2.html](https://musez.github.io/web-dev-tools/pages/textScroll/text_scroll2.html)
```html
<!DOCTYPE html>
<html lang="en">
<head>
...
**演示地址：**[https://musez.github.io/web-dev-tools/pages/textScroll/text_scroll3.html](https://musez.github.io/web-dev-tools/pages/textScroll/text_scroll3.html)
```html
<!DOCTYPE html>
<html lang="en">
<head>
...
### 春节横幅iframe
**演示地址：**[https://musez.github.io/web-dev-tools/pages/textScroll/index.html](https://musez.github.io/web-dev-tools/pages/textScroll/index.html)
> 嵌套页
```html
<!DOCTYPE html>
<html lang="en">
...
<body>
<iframe id="newYearWindow" width="1022" height="680" scrolling="no" src="text_scroll4.html" frameborder="0"
        style="margin: 0 auto;position: fixed;top: 36px;left: 0;right: 0;"></iframe>


<script src="https://cdn.bootcss.com/jquery/1.8.3/jquery.min.js"></script>

<script>
    function closeNewYearWindow() {
        $("#newYearWindow").remove();
    }
</script>
</body>
</html>
...
<body>
<div class="text-scroll_wrapper hide">
    <div class="text-scroll">
        <a class="close" href="javascript:;"></a>
        <embed id="embedPlayer" src="9680.mp3" autostart="true" loop="true" hidden="true" height="0"/>
...
<script>
    $(document).ready(function () {
        ...
        function bannerTimer(beginTime, endTime) {
            ...
            if (currTime >= beginTime && currTime <= endTime) {//时间之间
                //do something 页面加载完成后弹广告
                $(".text-scroll_wrapper").removeClass("hide").addClass("show");
                ...
                $(".text-scroll_wrapper .close").click(function () {
                    ...
                    //移除dom
                    window.parent.frames.closeNewYearWindow();
                });
